...
const data = [
    ...
    {
        id: 3, icon: <FaServer/>, title: 'Full-Stack Development', desc: "I have worked on both the back-end and front-end of systems. I have developed fully fledged website (with databases, servers and clients)"
    }
]
